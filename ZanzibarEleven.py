#This one succesfully does them one at a time, but soon runs into captchas on thatcar.nz. Will have to find work around using government API as other sites use java, cloudflare, or suck 
...
while True:
    plate_number = input("Please enter a license plate number: ")
    ...
    try:
        ...
        data.append({'User': user_name, 'Plate Number': plate_number.upper(), 'VIN': car_data['VIN'], 'Safety Rating': car_data['Safety Rating']})
        print("Car Loaded")
